!(function (t, e) {
  ...
  class n {
    static parse(t, n) {
      ...
      var D = new e.Byte(x);
      for (
        M > 0 && (t._publicExtData = c.slice(M, c.byteLength)),
        ...
        for (v.totalKeyframeDatasLength = 0, l = 0; l < A; l++) {
          ...
          S.childs = [];
          var b = n.getInt16();
          (b >= 0 && ((S.name = y[b]), (v.bone3DMap[S.name] = l)),
            (S.keyFrame = []),
            (S.parentIndex = n.getInt16()),
            -1 == S.parentIndex
              ? (S.parent = null)
              : (S.parent = v.nodes[S.parentIndex]),
            (S.lerpType = n.getUint8()));
          var T = n.getUint32();
          D.pos = T;
          var C = (S.keyframeWidth = D.getUint16());
          if (
            ((v.totalKeyframeDatasLength += C),
          ...
          for (o = 0, u = w; o < u; o++) {
            if (
              (((k = S.keyFrame[o] = new s()).duration = n.getFloat32()),
              (k.startTime = U),
              2 === S.lerpType)
            ) {
              k.interpolationData = [];
              ...
              switch ((B = n.getFloat32())) {
                ...
                case 255:
                  ...
                  break;
                default:
                  for (k.interpolationData.push(B), _ = 1; _ < P; _++)
                    k.interpolationData.push(n.getFloat32());
              }
            }
            for (
              k.data = new Float32Array(C),
              ...
              ((k.data[p] = n.getFloat32()),
                k.data[p] > -1e-8 && k.data[p] < 1e-8 && (k.data[p] = 0));
            U += k.duration;
          }
  ...
  class h {
    ...
    static READ_BLOCK() {
      for (
        var t = (h._BLOCK.count = h._reader.getUint16()),
          e = (h._BLOCK.blockStarts = []),
          i = (h._BLOCK.blockLengths = []),
          a = 0;
        a < t;
        a++
      )
    ...
    static READ_ANIMATIONS() {
      var t,
        ...
        p = o.getUint16(),
        _ = [];
      for (_.length = p, t = 0; t < p; t++)
        _[t] = i.AnimationTemplet.interpolation[o.getByte()];
      var d = o.getUint8();
      for (h._templet._anis.length = d, t = 0; t < d; t++) {
        ...
        for (c.totalKeyframeDatasLength = 0, e = 0; e < x; e++) {
          ...
          ((y.keyframeWidth = p), (y.childs = []));
          var g = o.getUint16();
          (g >= 0 && ((y.name = h._strings[g]), (c.bone3DMap[y.name] = e)),
            (y.keyFrame = []),
            (y.parentIndex = o.getInt16()),
            -1 == y.parentIndex
              ? (y.parent = null)
              : (y.parent = c.nodes[y.parentIndex]),
            (c.totalKeyframeDatasLength += p),
            (y.interpolationMethod = _),
          ...
          for (n = 0, l = f; n < l; n++) {
            (((M = y.keyFrame[n] = new s()).startTime = o.getFloat32()),
              ...
              (M.dData = new Float32Array(p)),
              (M.nextData = new Float32Array(p)));
          ...
          ((M.duration = 0),
            ...
            h._templet._calculateKeyFrame(y, f, p));
        }
      }
    }
  }
  ...
  class o extends e.EventDispatcher {
    ...
    set templet(t) {
      (this.state !== l.stopped && this.stop(!0),
        this._templet !== t &&
          ((this._templet = t), this._computeFullKeyframeIndices()));
    }
    get playStart() {
    ...
    _setPlayParams(t, e) {
      ((this._currentTime = t),
        (this._currentKeyframeIndex = Math.floor(
          this.currentPlayTime / e + 0.01,
        )),
    ...
    _setPlayParamsWhenStop(t, e, i = -1) {
      this._currentTime = t;
      var a = i > 0 ? i : t;
      ((this._currentKeyframeIndex = Math.floor(a / e + 0.01)),
        (this._currentKeyframeIndex = Math.floor(t / e + 0.01)),
        (this._currentFrameTime = this._currentKeyframeIndex * e),
        (this._currentAnimationClipIndex = -1));
    }
    _update(t) {
      if (
        ...
        var i = this._cacheFrameRateInterval * this._cachePlayRate,
          a = 0;
        this._startUpdateLoopCount !== e.Stat.loopCount &&
          ((a = t * this.playbackRate), (this._elapsedPlaybackTime += a));
        var r = this.playDuration;
        if (
          ((a += this._currentTime),
          (0 !== this._overallDuration &&
            this._elapsedPlaybackTime >= this._overallDuration) ||
            (0 === this._overallDuration && this._elapsedPlaybackTime >= r) ||
            (0 === this._overallDuration && a >= this.playEnd))
        )
          return (
            this._setPlayParamsWhenStop(r, i, this.playEnd),
            void this.event(e.Event.STOPPED)
          );
        if (r > 0) {
          if (a >= r)
            return this._stopWhenCircleFinish
              ? (this._setPlayParamsWhenStop(r, i),
                (this._stopWhenCircleFinish = !1),
                void this.event(e.Event.STOPPED))
              : ((a %= r),
  ...
  class u {
    ...
    static getBezierRate(t, e, i, a, r) {
      ...
      var h,
        l,
        o = u._getBezierPoints(e, i, a, r, s);
  ...
  class p extends e.Resource {
    ...
    static _QuaternionInterpolation_1(t, i, a, r, s, n, h, l, o, u = null) {
      var p = 0 === l ? 0 : n / l;
      return (e.MathUtil.slerpQuaternionArray(s, i, o, i, p, a, r), 4);
    }
    ...
    static _Matrix4x4Interpolation_4(t, e, i, a, r, s, n, h, l, o = null) {
      for (let t = 0; t < 16; t++, e++) i[a + t] = r[e] + s * n[e];
      return 16;
    }
    static _NoInterpolation_5(t, e, i, a, r, s, n, h, l, o = null) {
      return ((i[a] = r[e]), 1);
    }
    static _BezierInterpolation_6(t, e, i, a, r, s, n, h, l, o = null, p = 0) {
      return (
        (i[a] =
          r[e] +
          (l[e] - r[e]) *
            u.getBezierRate(s / h, o[p], o[p + 1], o[p + 2], o[p + 3])),
        5
      );
    }
    static _BezierInterpolation_7(t, e, i, a, r, s, n, h, l, o = null, p = 0) {
      return (
        (i[a] =
          o[p + 4] +
          o[p + 5] *
    ...
    _calculateKeyFrame(t, e, i) {
      ...
      for (var r = 0; r < e; r++)
        for (var s = a[r], n = 0; n < i; n++)
          ((s.dData[n] =
            0 === s.duration ? 0 : (a[r + 1].data[n] - s.data[n]) / s.duration),
    ...
    _onAsynLoaded(t, i = null) {
      var a = new e.Byte(t);
      if (
        ((this._aniVersion = a.readUTFString()),
        "LAYAANIMATION:02" === this._aniVersion)
      )
        h.parse(this, a);
      else n.parse(this, a);
    }
    ...
    getOriginalData(t, e, i, a, r) {
      ...
      for (var h = 0, l = 0, o = s.length, u = 0; l < o; l++) {
        var _,
          d = s[l],
          c = d.keyFrame;
        ((_ = c[this.getNodeKeyFrame(c, l, r)]), (d.dataOffset = u));
        var m = r - _.startTime,
          x = d.lerpType;
        if (x)
          switch (x) {
    ...
    getNodesCurrentFrameIndex(t, e) {
      ...
      for (var a = 0, r = i.length; a < r; a++) {
        var s = i[a];
        for (
          e < this.unfixedCurrentTimes[a] &&
            (this.unfixedCurrentFrameIndexes[a] = 0),
            this.unfixedCurrentTimes[a] = e;
          this.unfixedCurrentFrameIndexes[a] < s.keyFrame.length &&
          !(
            s.keyFrame[this.unfixedCurrentFrameIndexes[a]].startTime >
            this.unfixedCurrentTimes[a]
          );
        )
    ...
    getOriginalDataUnfixedRate(t, e, i) {
      ...
      for (var r = 0, s = 0, n = a.length, h = 0; s < n; s++) {
        var l = a[s];
        for (
          i < this.unfixedCurrentTimes[s] &&
            (this.unfixedCurrentFrameIndexes[s] = 0),
            this.unfixedCurrentTimes[s] = i;
          this.unfixedCurrentFrameIndexes[s] < l.keyFrame.length &&
          !(
            l.keyFrame[this.unfixedCurrentFrameIndexes[s]].startTime >
            this.unfixedCurrentTimes[s]
          );
        )
          ((this.unfixedKeyframes[s] =
            l.keyFrame[this.unfixedCurrentFrameIndexes[s]]),
  ...
  ((p.interpolation = [
    ...
    p._QuaternionInterpolation_1,
    p._AngleInterpolation_2,
    p._RadiansInterpolation_3,
    p._Matrix4x4Interpolation_4,
    p._NoInterpolation_5,
    p._BezierInterpolation_6,
    p._BezierInterpolation_7,
  ]),
    (i.AnimationTemplet = p));
  class _ extends e.Graphics {
    drawSkin(t, i) {
      this.drawTriangles(
        t.texture,
        0,
        ...
        t.uvs,
        t.indexes,
        t.transform || e.Matrix.EMPTY,
        i,
      );
    }
    static create() {
      return _._caches.pop() || new _();
    }
    static recycle(t) {
      (t.clear(), _._caches.push(t));
    }
  }
  _._caches = [];
  class d {
    ...
    _applyIk1(t, e, i, a) {
      var r = t.parentBone,
        ...
        u = Math.atan2(o, l) * d.radDeg - 0 - t.transform.skX;
    ...
    _applyIk2(t, i, a, r, s, n) {
      if (0 != n) {
        var h,
          l,
          o,
          u = t.resultTransform.x,
          p = t.resultTransform.y,
          _ = t.transform.scX,
          c = t.transform.scY,
          m = i.transform.scX;
        (_ < 0 ? ((_ = -_), (h = 180), (o = -1)) : ((h = 0), (o = 1)),
          c < 0 && ((c = -c), (o = -o)),
          m < 0 ? ((m = -m), (l = 180)) : (l = 0));
        var x,
          y,
          g,
          f = i.resultTransform.x,
          M = t.resultMatrix.a,
          D = t.resultMatrix.c,
          v = t.resultMatrix.b,
          I = t.resultMatrix.d,
          A = Math.abs(_ - c) <= 1e-4;
        (A
          ? ((y = M * f + D * (x = i.resultTransform.y) + t.resultMatrix.tx),
            (g = v * f + I * x + t.resultMatrix.ty))
          : ((x = 0),
            (y = M * f + t.resultMatrix.tx),
            (g = v * f + t.resultMatrix.ty)),
          this.isDebug &&
            (this._sp ||
              ((this._sp = new e.Sprite()), e.ILaya.stage.addChild(this._sp)),
            this._sp.graphics.clear(),
            this._sp.graphics.drawCircle(a, r, 15, "#ffff00"),
            this._sp.graphics.drawCircle(y, g, 15, "#ff00ff")),
          t.setRotation(
            Math.atan2(g - t.resultMatrix.ty, y - t.resultMatrix.tx),
          ));
        var S = t.parentBone;
        ((M = S.resultMatrix.a),
          (D = S.resultMatrix.c),
        ...
        var b,
          T,
          C = 1 / (M * (I = S.resultMatrix.d) - D * v),
          F = a - S.resultMatrix.tx,
          w = r - S.resultMatrix.ty,
          k = (F * I - w * D) * C - u,
          U = (w * M - F * v) * C - p,
          B =
            ((F = y - S.resultMatrix.tx) * I -
              (w = g - S.resultMatrix.ty) * D) *
              C -
            u,
          P = (w * M - F * v) * C - p,
          L = Math.sqrt(B * B + P * P),
          N = i.length * m;
        if (A) {
          var E = (k * k + U * U - L * L - (N *= _) * N) / (2 * L * N);
          (E < -1 ? (E = -1) : E > 1 && (E = 1),
            (T = Math.acos(E) * s),
            (M = L + N * E),
            (D = N * Math.sin(T)),
            (b = Math.atan2(U * M - k * D, k * M + U * D)));
        } else {
          var R = (M = _ * N) * M,
            V = (D = c * N) * D,
            O = k * k + U * U,
            ...
            Y = -2 * V * L,
            X = V - R;
          if ((I = Y * Y - 4 * X * (v = V * L * L + R * O - R * V)) > 0) {
            var W = Math.sqrt(I);
            Y < 0 && (W = -W);
            var z = (W = -(Y + W) / 2) / X,
              G = v / W,
          ...
          var H = 0,
            ...
            tt = 0,
            et = 0;
          ((I = (F = L + M) * F) > $ && ((J = 0), ($ = I), (tt = F)),
            (I = (F = L - M) * F) < Q && ((H = Math.PI), (Q = I), (Z = F)));
          var it = Math.acos((-M * L) / (R - V));
          ((I = (F = M * Math.cos(it) + L) * F + (w = D * Math.sin(it)) * w) <
            Q && ((H = it), (Q = I), (Z = F), (j = w)),
            I > $ && ((J = it), ($ = I), (tt = F), (et = w)),
            O <= (Q + $) / 2
              ? ((b = K - Math.atan2(j * s, Z)), (T = H * s))
              : ((b = K - Math.atan2(et * s, tt)), (T = J * s)));
        }
        var at = Math.atan2(x, f) * o,
          rt = t.resultTransform.skX;
        ((b = (b - at) * d.radDeg + h - rt) > 180
          ? (b -= 360)
          : b < -180 && (b += 360),
          (t.resultTransform.x = u),
          (t.resultTransform.y = p),
          (t.resultTransform.skX = t.resultTransform.skY = rt + b * n),
          (rt = i.resultTransform.skX),
          (rt %= 360),
          (T = ((T + at) * d.radDeg - 0) * o + l - rt) > 180
            ? (T -= 360)
            : T < -180 && (T += 360),
          (i.resultTransform.x = f),
          (i.resultTransform.y = x),
          (i.resultTransform.skX = i.resultTransform.skY =
            i.resultTransform.skY + T * n),
          t.update());
      }
    }
    _applyIk3(t, i, a, r, s, n) {
      ...
      const M = g * g + f * f,
        D = Math.sqrt(M),
        v = (g = a - t.resultMatrix.tx) * g + (f = r - t.resultMatrix.ty) * f,
        I = Math.sqrt(v);
      if (_ + D <= I || I + _ <= D || I + D <= _) {
        var A;
        ((x = c + ((A = _ + D <= I ? 1 : -1) * (a - c) * D) / I),
          (y = m + (A * (r - m) * D) / I));
      } else {
        const t = (M - p + v) / (2 * v),
          e = Math.sqrt(M - t * t * v) / I,
          i = c + g * t,
          a = m + f * t,
          r = -f * e,
          n = g * e;
        s > 0 ? ((x = i - r), (y = a - n)) : ((x = i + r), (y = a + n));
      }
      var S, b, T, C;
      ((h = x),
        (l = y),
        this.isDebug &&
          (this._sp ||
            ((this._sp = new e.Sprite()), e.ILaya.stage.addChild(this._sp)),
          this._sp.graphics.clear(),
          this._sp.graphics.drawCircle(c, m, 15, "#ff00ff"),
          this._sp.graphics.drawCircle(a, r, 15, "#ffff00"),
          this._sp.graphics.drawCircle(h, l, 15, "#ff00ff")),
        (S = Math.atan2(l - t.resultMatrix.ty, h - t.resultMatrix.tx)),
        t.setRotation(S),
        (b = d._tempMatrix).identity(),
        b.rotate(S),
        b.scale(t.resultMatrix.getScaleX(), t.resultMatrix.getScaleY()),
        b.translate(t.resultMatrix.tx, t.resultMatrix.ty),
        b.copyTo(t.resultMatrix),
        t.updateChild(),
        (T = Math.atan2(r - l, a - h)),
        i.setRotation(T),
        (C = d._tempMatrix).identity(),
        C.rotate(T),
        C.scale(i.resultMatrix.getScaleX(), i.resultMatrix.getScaleY()),
        C.translate(h, l),
        b.copyTo(i.resultMatrix),
        i.updateChild());
    }
  }
  ((d.radDeg = 180 / Math.PI),
    (d.degRad = Math.PI / 180),
    (d._tempMatrix = new e.Matrix()));
  class c {
    constructor(t, e) {
      ((this._debugKey = !1),
        (this._segments = []),
    ...
    apply(t, e) {
      if (this.target) {
        ...
        else for (m = 1; m < _; m++) d[m] = c;
        var D = this.computeWorldPositions(
          this.target,
          t,
          e,
          _,
        ...
        for (m = 0, I = 3; m < p; m++, I += 3) {
          ...
          if (((A = f), (S = M), r)) {
            ...
            ((k = l ? D[I - 1] : 0 == d[m + 1] ? D[I + 2] : Math.atan2(F, C)),
              (k -= Math.atan2(N, P) - (b / 180) * Math.PI),
              T &&
                ((U = Math.cos(k)),
                (B = Math.sin(k)),
                (A += ((g = y.length) * (U * P - B * N) - C) * a),
                (S += (g * (B * P + U * N) - F) * a)),
              k > Math.PI
                ? (k -= 2 * Math.PI)
              ...
              (U = Math.cos(k)),
              (B = Math.sin(k)),
              (y.resultMatrix.a = U * P - B * N),
              (y.resultMatrix.c = U * L - B * E),
              (y.resultMatrix.b = B * P + U * N),
              (y.resultMatrix.d = B * L + U * E));
          }
        }
      }
    }
    computeWorldVertices2(t, e, i, a, r, s) {
      var n,
        h,
        l,
        o = t.currDisplayData.bones,
        u = t.currDisplayData.weights,
        p = t.currDisplayData.triangles,
        _ = 0,
        d = 0,
        m = 0,
        x = 0,
        ...
        v = 0;
      if (null != o) {
        for (_ = 0; _ < i; _ += 2) ((d += (x = o[d]) + 1), (m += x));
        var I = e;
        for (y = s, g = 3 * m; y < a; y += 2) {
          for (f = 0, M = 0, x = o[d++], x += d; d < x; d++, g += 3) {
            ((n = I[o[d]].resultMatrix), (D = u[g]), (v = u[g + 1]));
            var A = u[g + 2];
            ((f += (D * n.a + v * n.c + n.tx) * A),
              (M += (D * n.b + v * n.d + n.ty) * A));
          }
          ((r[y] = f), (r[y + 1] = M));
        }
      } else {
        var S, b;
        if (
          (p || (p = u), t.deformData && (p = t.deformData), (S = t.parent), e)
        )
          for (l = e.length, _ = 0; _ < l; _++)
            if (e[_].name == S) {
              h = e[_];
              break;
            }
        (h && (b = h.resultMatrix), b || (b = c._tempMt));
        var T = b.tx,
          C = b.ty,
          F = b.a,
          w = b.b,
          k = b.c,
          U = b.d;
        for (h && (U *= h.d), d = i, y = s; y < a; d += 2, y += 2)
          ((D = p[d]),
            (v = p[d + 1]),
            (r[y] = D * F + v * w + T),
            (r[y + 1] = -(D * k + v * U + C)));
    ...
    computeWorldPositions(t, e, i, a, r, s, n) {
      ...
      var A,
        ...
        V = 0,
        O = 0;
      for (x = 0, U = 2; x < D; x++, U += 6)
        ((C =
          2 * (A = 0.1875 * (B - 2 * (L = h[U]) + (E = h[U + 2]))) +
          (b = 0.09375 * (3 * (L - E) - B + (V = h[U + 4])))),
          (F =
            2 * (S = 0.1875 * (P - 2 * (N = h[U + 1]) + (R = h[U + 3]))) +
            (T = 0.09375 * (3 * (N - R) - P + (O = h[U + 5])))),
          (w = 0.75 * (L - B) + A + 0.16666667 * b),
          (k = 0.75 * (N - P) + S + 0.16666667 * T),
          (l += Math.sqrt(w * w + k * k)),
          (w += C),
          (k += F),
          (C += b),
      ...
      var K,
        Y = this._segments,
        X = 0;
      for (x = 0, o = 0, u = 0, K = 0; x < a; x++, o += 3)
        if ((p = g += _ = f[x]) < 0) this.addBeforePosition(p, h, 0, M, o);
        else if (p > l) this.addAfterPosition(p - l, h, y - 4, M, o);
        else {
          for (; ; u++)
            if (!(p > (c = I[u]))) {
              0 == u ? (p /= c) : (p = (p - (d = I[u - 1])) / (c - d));
              break;
            }
          if (u != v) {
            v = u;
            ...
            for (
              C =
                2 *
                  (A =
                    0.03 * ((B = h[W]) - 2 * (L = h[W + 2]) + (E = h[W + 4]))) +
                (b = 0.006 * (3 * (L - E) - B + (V = h[W + 6]))),
                F =
                  2 *
                    (S =
                      0.03 *
                      ((P = h[W + 1]) - 2 * (N = h[W + 3]) + (R = h[W + 5]))) +
                  (T = 0.006 * (3 * (N - R) - P + (O = h[W + 7]))),
                w = 0.3 * (L - B) + A + 0.16666667 * b,
                k = 0.3 * (N - P) + S + 0.16666667 * T,
                X = Math.sqrt(w * w + k * k),
                Y[0] = X,
                W = 1;
              W < 8;
    ...
    addCurvePosition(t, e, i, a, r, s, n, h, l, o, u, p) {
      0 == t && (t = 1e-4);
      var _ = t * t,
        d = _ * t,
        c = 1 - t,
    ...
    apply() {
      for (
        var t,
          ...
          a = this.target.resultMatrix.c,
          r = this.target.resultMatrix.d,
          s = 0,
          n = this._bones.length;
        s < n;
        s++
      ) {
        if (((t = this._bones[s]), this.rotateMix > 0)) {
          ...
          (p > Math.PI
            ? (p -= 2 * Math.PI)
            : p < -Math.PI && (p += 2 * Math.PI),
            (p *= this.rotateMix));
          var _ = Math.cos(p),
            d = Math.sin(p);
          ((t.resultMatrix.a = _ * h - d * o),
            (t.resultMatrix.b = _ * l - d * u),
            (t.resultMatrix.c = d * h + _ * o),
            (t.resultMatrix.d = d * l + _ * u));
        }
        if (
          (this.translateMix &&
          ...
          var c = Math.sqrt(
            ...
            x =
              c > 1e-5
                ? (c + (m - c + this._data.offsetScaleX) * this.scaleMix) / c
                : 0;
          ((t.resultMatrix.a *= x),
            (t.resultMatrix.c *= x),
            (c = Math.sqrt(
            ...
            (x =
              c > 1e-5
                ? (c + (m - c + this._data.offsetScaleY) * this.scaleMix) / c
                : 0),
            (t.resultMatrix.b *= x),
            (t.resultMatrix.d *= x));
        }
        if (this.shearMix > 0) {
          ...
          ((p =
            Math.atan2(r, i) -
            Math.atan2(a, e) -
            (y - Math.atan2(t.resultMatrix.c, t.resultMatrix.a))) > Math.PI
            ? (p -= 2 * Math.PI)
            : p < -Math.PI && (p += 2 * Math.PI),
            (p =
              y +
              (p + (this._data.offsetShearY * Math.PI) / 180) * this.shearMix),
            (x = Math.sqrt(l * l + u * u)),
            (t.resultMatrix.b = Math.cos(p) * x),
            (t.resultMatrix.d = Math.sin(p) * x));
        }
      }
    }
  }
  class x extends e.Sprite {
    ...
    set index(t) {
      this.player &&
        ...
        (this._aniClipIndex < 0 || this._aniClipIndex >= this.getAnimNum()) &&
          ((this._aniClipIndex = 0),
          (this._currAniIndex = 0),
          (this._curOriginalData = new Float32Array(
            this._templet.getTotalkeyframesLength(this._currAniIndex),
          )),
          (this._drawOrder = null),
          (this._eventIndex = 0)),
        this._update(!1));
    ...
    set skinName(t) {
      ((this._skinName = t), this._templet && this.showSkinByName(t));
    }
    get animationName() {
    ...
    set animationName(t) {
      ((this._animationName = t),
        this._templet && this.play(t, this._loop, !0));
    }
    get loop() {
      return this._loop;
    }
    ...
    set source(t) {
      ((this._source = t),
        t
          ? e.ILaya.loader.load(t).then((t) => {
              !this._source ||
                (t && !t.isCreateFromURL(this._source)) ||
                (this.templet = t);
            })
          : (this.templet = null));
    }
    ...
    init(t) {
      if (
        ...
        if (1 == this._aniMode) {
          this._graphicsCache = [];
          for (let e = 0, i = t.getAnimationCount(); e < i; e++)
        ...
        if (
          ...
          this._ikArr = [];
          for (let e = 0, i = t.ikArr.length; e < i; e++)
            this._ikArr.push(new d(t.ikArr[e], this._boneList));
        }
        if (t.pathArr.length > 0) {
          this._pathDic = {};
          for (let e = 0, i = t.pathArr.length; e < i; e++) {
            let i = t.pathArr[e],
              a = new c(i, this._boneList),
              r = this._boneSlotDic[i.name];
            (r && ((a = new c(i, this._boneList)), (a.target = r)),
              (this._pathDic[i.name] = a));
          }
        }
        if (t.tfArr.length > 0) {
          this._tfArr = [];
          for (let e = 0, i = t.tfArr.length; e < i; e++)
            this._tfArr.push(new m(t.tfArr[e], this._boneList));
        }
        (t.skinDataArray.length > 0 &&
    ...
    load(t, i) {
      e.ILaya.loader.load(t).then((e) => {
        null != e &&
          e.isCreateFromURL(t) &&
          (this.init(e), this.play(0, !0), i && i.runWith(this));
      });
    }
    _onPlay() {
      this.event(e.Event.PLAYED);
    ...
    _onStop() {
      let t = this._templet.eventAniArr[this._aniClipIndex];
      if (t && this._eventIndex < t.length)
        for (; this._eventIndex < t.length; this._eventIndex++) {
          let i = t[this._eventIndex];
          i.time >= this._player.playStart &&
            i.time <= this._player.playEnd &&
            this.event(e.Event.LABEL, i);
        }
    ...
    _parseSrcBoneMatrix() {
      ...
      if (0 == this._aniMode)
        ...
        ((this._boneSlotDic = {}),
          ...
          (this._boneSlotArray = []));
        let t = this._templet.boneSlotArray;
        for (let e = 0, i = t.length; e < i; e++) {
          let i = t[e],
            a = this._bindBoneBoneSlotDic[i.parent];
          (null == a && (this._bindBoneBoneSlotDic[i.parent] = a = []),
    ...
    _emitMissedEvents(t, i, a = 0) {
      let r = this._templet.eventAniArr[this._player.currentAnimationClipIndex];
      if (r) {
        let t = r.length;
        for (let i = a; i < t; i++) {
          let t = r[i];
          t.time >= this._player.playStart &&
            t.time <= this._player.playEnd &&
            this.event(e.Event.LABEL, t);
        }
      }
    }
    _update(t = !0) {
      if (t && this._pause) return;
      if (t && this._indexControl) return;
      let i = this.timer.currTimer,
        a = this._player.currentKeyframeIndex,
        r = i - this._lastTime;
      if (
        (t ? this._player._update(r) : (a = -1),
        (this._lastTime = i),
      ...
      ((this._lastUpdateAniClipIndex = this._aniClipIndex),
        a > this._clipIndex &&
          ...
          (this._eventIndex = 0)));
      let s = this._templet.eventAniArr[this._aniClipIndex];
      if (s && this._eventIndex < s.length) {
        let t = s[this._eventIndex];
        if (
          t.time >= this._player.playStart &&
          t.time <= this._player.playEnd
        ) {
          if (
            this._player.currentPlayTime >= t.time &&
            (this.event(e.Event.LABEL, t),
            this._eventIndex++,
            this._playAudio &&
              t.audioValue &&
              "null" !== t.audioValue &&
              "undefined" !== t.audioValue)
          ) {
            let i = e.SoundManager.playSound(
              this._player.templet._path + t.audioValue,
              1,
              e.Handler.create(this, this._onAniSoundStoped),
            );
            ((e.SoundManager.playbackRate = this._player.playbackRate),
              i && this._soundChannelArr.push(i));
          }
        } else if (
          t.time < this._player.playStart &&
          this._playAudio &&
          ...
          let i = e.SoundManager.playSound(
            ...
            e.Handler.create(this, this._onAniSoundStoped),
            null,
            (this._player.currentPlayTime - t.time) / 1e3,
          );
          ((e.SoundManager.playbackRate = this._player.playbackRate),
            i && this._soundChannelArr.push(i));
        } else this._eventIndex++;
      }
      if (0 == this._aniMode) {
        let t =
        ...
        t && this.graphics != t && (this.graphics = t);
      } else if (1 == this._aniMode) {
        let t =
          this._getGrahicsDataWithCache(this._aniClipIndex, this._clipIndex) ||
          this._createGraphics();
        t && this.graphics != t && (this.graphics = t);
      } else this._createGraphics();
    }
    _onAniSoundStoped(t) {
      for (let e = this._soundChannelArr.length - 1; e >= 0; e--) {
        let i = this._soundChannelArr[e];
        (i.isStopped || t) &&
          (!i.isStopped && i.stop(), this._soundChannelArr.splice(e, 1));
      }
    }
    _createGraphics(t = -1) {
      -1 == t && (t = this._clipIndex);
      let i = t * this._player.cacheFrameRateInterval,
        a = this._templet.drawOrderAniArr[this._aniClipIndex];
      if (a && a.length > 0) {
        this._drawOrderIndex = 0;
        let t = a[this._drawOrderIndex];
        for (
          ;
          i >= t.time &&
          ((this._drawOrder = t.drawOrder),
          this._drawOrderIndex++,
          !(this._drawOrderIndex >= a.length));
        )
          t = a[this._drawOrderIndex];
      }
      0 == this._aniMode || 1 == this._aniMode
        ? (this.graphics = _.create())
        : this.graphics instanceof _
          ? this.graphics.clear()
          : (this.graphics = _.create());
      let r = this.graphics,
      ...
      this._templet.getOriginalData(
        ...
        null,
        t,
        n ? i + this._player.cacheFrameRateInterval : i,
      );
      let h = this._aniSectionDic[this._aniClipIndex],
        l = 0,
        o = 0,
        u = 0,
        p = 0,
        d = 0,
        c = this._templet.srcBoneMatrixArr.length,
        m = this._curOriginalData;
      for (o = 0, d = h[0]; o < c; o++) {
        let t = this._boneList[o].resultTransform,
          e = this._templet.srcBoneMatrixArr[o];
        ((t.scX = e.scX * m[l++]),
          (t.skX = e.skX + m[l++]),
          (t.skY = e.skY + m[l++]),
          (t.scY = e.scY * m[l++]),
          ...
          8 === this._templet.tMatrixDataLen &&
            ((t.skewX = e.skewX + m[l++]), (t.skewY = e.skewY + m[l++])));
      }
      let x = {},
        y = {};
      for (d += h[1]; o < d; o++) {
        let t = s[o];
        ((x[t.name] = m[l++]), (y[t.name] = m[l++]), (l += 4));
      }
      let g = {},
        f = {};
      for (d += h[2]; o < d; o++) {
        let t = s[o];
        ((g[t.name] = m[l++]), (f[t.name] = m[l++]), (l += 4));
      }
      if (this._pathDic)
        for (d += h[3]; o < d; o++) {
          let t = s[o],
            i = this._pathDic[t.name];
          if (i) {
            switch (new e.Byte(t.extenData).getByte()) {
              case 1:
                i.position = m[l++];
                break;
              case 2:
                ...
                break;
              case 3:
                ((i.rotateMix = m[l++]), (i.translateMix = m[l++]));
            }
          }
        }
      if (
        (this._rootBone.update(
          this._yReverseMatrix || e.Matrix.TEMP.identity(),
        ),
        this._ikArr)
      ) {
        let t;
        for (o = 0, d = this._ikArr.length; o < d; o++)
          ((t = this._ikArr[o]),
            t.name in g && (t.bendDirection = g[t.name]),
            t.name in f && (t.mix = f[t.name]),
            t.apply());
      }
      if (this._pathDic)
        for (let t in this._pathDic) {
          this._pathDic[t].apply(this._boneList, r);
        }
      if (this._tfArr)
        for (o = 0, p = this._tfArr.length; o < p; o++) {
          this._tfArr[o].apply();
        }
      for (o = 0, p = this._boneList.length; o < p; o++) {
        let t = this._boneList[o],
          e = this._bindBoneBoneSlotDic[t.name];
        if ((t.resultMatrix.copyTo(this._boneMatrixArray[o]), e))
          for (u = 0, d = e.length; u < d; u++) {
            let i = e[u];
            i && i.setParentMatrix(t.resultMatrix);
          }
      }
      let M = {},
        ...
        if (this._lastAniClipIndex != this._aniClipIndex)
          for (
            this._lastAniClipIndex = this._aniClipIndex,
              o = 0,
              d = this._boneSlotArray.length;
            o < d;
            o++
          ) {
            this._boneSlotArray[o].deformData = null;
          }
        let t,
          e = D[this._aniClipIndex],
          a = e.default;
        for (t in (this._setDeform(a, M, this._boneSlotArray, i), e))
          "default" != t &&
            t != this._skinName &&
            ((a = e[t]), this._setDeform(a, M, this._boneSlotArray, i));
        ((a = e[this._skinName]),
          this._setDeform(a, M, this._boneSlotArray, i));
      }
      if (this._drawOrder)
        for (o = 0, d = this._drawOrder.length; o < d; o++) {
          let t = this._boneSlotArray[this._drawOrder[o]],
            e = x[t.name],
            i = y[t.name];
          if (
            (isNaN(e) ||
              ...
              (this._templet.attachmentNames
                ? t.showDisplayByName(this._templet.attachmentNames[e])
                : t.showDisplayByIndex(e)),
            M[this._drawOrder[o]])
          ) {
            let e = M[this._drawOrder[o]];
            t.currDisplayData && e[t.currDisplayData.attachmentName]
              ? (t.deformData = e[t.currDisplayData.attachmentName])
              : (t.deformData = null);
          } else t.deformData = null;
          isNaN(i)
            ? t.draw(r, this._boneMatrixArray, 2 == this._aniMode)
            : t.draw(r, this._boneMatrixArray, 2 == this._aniMode, i);
        }
      else
        for (o = 0, d = this._boneSlotArray.length; o < d; o++) {
          let t = this._boneSlotArray[o],
            e = x[t.name],
            i = y[t.name];
          if (
            (isNaN(e) ||
    ...
    _checkIsAllParsed(t) {
      let e = Math.floor(
        0.01 +
          (this._templet.getAniDuration(t) / 1e3) * this._player.cacheFrameRate,
      );
      for (let i = 0; i < e; i++)
        if (!this._templet.getGrahicsDataWithCache(t, i)) return;
      this._templet.getGrahicsDataWithCache(t, e)
        ? this._templet.deleteAniData(t)
        : this._createGraphics(e);
    }
    _setDeform(t, e, i, a) {
      if (!t) return;
      let r, s, n;
      if (t)
        for (let h = 0, l = t.deformSlotDataList.length; h < l; h++) {
          r = t.deformSlotDataList[h];
          for (let t = 0; t < r.deformSlotDisplayList.length; t++)
            ((s = r.deformSlotDisplayList[t]),
              (n = i[s.slotIndex]),
              s.apply(a, n),
    ...
    showSkinByIndex(t, e = !0) {
      for (let t = 0; t < this._boneSlotArray.length; t++)
        this._boneSlotArray[t].showSlotData(null, e);
      if (this._templet.showSkinByIndex(this._boneSlotDic, t, e)) {
        let e = this._templet.skinDataArray[t];
        this._skinName = e.name;
      }
      this._clearCache();
    }
    showSlotSkinByIndex(t, e) {
      if (0 == this._aniMode) return;
      let i = this.getSlotByName(t);
    ...
    _clearCache() {
      if (1 == this._aniMode)
        for (let e = 0, i = this._graphicsCache.length; e < i; e++) {
          for (let i = 0, a = this._graphicsCache[e].length; i < a; i++) {
            var t = this._graphicsCache[e][i];
            t && t != this.graphics && _.recycle(t);
          }
    ...
    play(t, i, a = !0, r = 0, s = 0, n = !0, h = !0) {
      ...
      let l = -1;
      var o;
      if (((o = i ? 2147483647 : 0), "string" == typeof t))
        for (let e = 0, i = this._templet.getAnimationCount(); e < i; e++) {
          let i = this._templet.getAnimation(e);
          if (i && t == i.name) {
            l = e;
            break;
          }
      ...
      l > -1 &&
        l < this.getAnimNum() &&
        ((this._aniClipIndex = l),
        (a || this._pause || this._currAniIndex != l) &&
          ((this._currAniIndex = l),
          (this._curOriginalData = new Float32Array(
            this._templet.getTotalkeyframesLength(l),
          )),
          (this._drawOrder = null),
          (this._eventIndex = 0),
          this._player.play(l, this._player.playbackRate, o, r, s),
          n &&
    ...
    paused() {
      if (!this._pause) {
        if (
          ...
          for (let t = this._soundChannelArr.length, e = 0; e < t; e++) {
            let t = this._soundChannelArr[e];
            t.isStopped || t.pause();
          }
        this.timer.clear(this, this._update);
      }
    ...
    destroy(t = !0) {
      (super.destroy(t), this._templet && this.reset());
    }
  }
  i.Skeleton = x;
  class y {
    ...
    getMatrix() {
      ...
      return (
        (t = this.mMatrix
          ? this.mMatrix
          : (this.mMatrix = new e.Matrix())).identity(),
  ...
  class g {
    ...
    update(t = null) {
      var i;
      if (((this.rotation = this.transform.skX), t))
        ...
        if (this.inheritRotation && this.inheritScale)
          ...
          this.inheritRotation
            ? ((a = Math.atan2(n.resultMatrix.b, n.resultMatrix.a)),
              (r = Math.cos(a)),
              (s = Math.sin(a)),
              u.setTo(r, s, -s, r, 0, 0),
      ...
      var p,
        _ = 0;
      for (_ = 0, p = this._children.length; _ < p; _++)
        this._children[_].update();
    }
    updateChild() {
      var t,
        e = 0;
  ...
  class I {
    ...
    binarySearch1(t, e) {
      ...
      if (0 == a) return 1;
      for (var r = a >>> 1; ; ) {
        if ((t[Math.floor(r + 1)] <= e ? (i = r + 1) : (a = r), i == a))
          return i + 1;
        r = (i + a) >>> 1;
      }
      return 0;
    ...
    apply(t, e, i = 1) {
      if (((t += 0.05), !(this.timeList.length <= 0))) {
        var a = 0;
        if (!(t < this.timeList[0])) {
          ...
          if (
            ...
            if (i < 1) for (a = 0; a < r; a++) s[a] += (h[a] - s[a]) * i;
            else for (a = 0; a < r; a++) s[a] = h[a];
            this.deformData = s;
          } else {
            var l,
              o = this.vectices[this.frameIndex - 1],
              u = this.vectices[this.frameIndex],
              p = this.timeList[this.frameIndex - 1],
              _ = this.timeList[this.frameIndex];
            for (
              i = this.tweenKeyList[n - 1] ? (t - p) / (_ - p) : 0, a = 0;
              a < r;
              a++
            )
              ((l = o[a]), (s[a] = l + (u[a] - l) * i));
  ...
  class b {
    ...
    static getAbsoluteUV(t, i, a = null) {
      if (0 == t[0] && 0 == t[1] && 1 == t[4] && 1 == t[5])
        return a ? (e.Utils.copyArray(a, i), a) : i;
      var r,
        s,
        n = t[0],
        h = t[2] - t[0],
        ...
        o = t[5] - t[1];
      for (
        a || (a = []), a.length = i.length, s = a.length, r = 0;
        r < s;
        r += 2
      )
  ...
  class F {
    ...
    getSaveVerticle(t) {
      return (
        F.useSameMatrixAndVerticle &&
        this._preGraphicVerticle &&
        F.isSameArr(t, this._preGraphicVerticle)
          ? (t = this._preGraphicVerticle)
          : ((t = e.Utils.copyArray([], t)), (this._preGraphicVerticle = t)),
        t
      );
    }
    static isSameMatrix(t, e) {
      return (
        ...
        t.c == e.c &&
        t.d == e.d &&
        Math.abs(t.tx - e.tx) < 1e-5 &&
        Math.abs(t.ty - e.ty) < 1e-5
      );
    }
    getSaveMatrix(t) {
      if (
        ...
        F.isSameMatrix(t, this._preGraphicMatrix)
      )
    ...
    draw(t, i, a = !1, r = 1) {
      if (
        ...
        var s,
          n = this.currTexture;
        switch (
          (this._diyTexture && (n = this._diyTexture),
            ...
            if (t) {
              ...
              if (this._parentMatrix) {
                ...
                if (h) {
                  var o;
                  if (
                    (e.Matrix.mul(h, this._parentMatrix, e.Matrix.TEMP),
                    a
                      ? (null == this._resultMatrix &&
                          (this._resultMatrix = new e.Matrix()),
                        (o = this._resultMatrix))
                      : (o = F._tempResultMatrix),
                    this._diyTexture && this.currDisplayData.uvs)
                  ) {
                    var u = F._tempMatrix;
                    (u.identity(),
                      this.currDisplayData.uvs[1] >
                        this.currDisplayData.uvs[5] && (u.d = -1),
                      this.currDisplayData.uvs[0] >
                        this.currDisplayData.uvs[4] &&
                        this.currDisplayData.uvs[1] >
                          this.currDisplayData.uvs[5] &&
                        ((l = !0), u.rotate(-Math.PI / 2)),
          ...
          case 1:
            ...
            if (null == this.currDisplayData.bones) {
              var _,
                d = this.currDisplayData.weights;
              (this.deformData && (d = this.deformData),
                this._diyTexture
                  ? (this._curDiyUV || (this._curDiyUV = []),
                    0 == this._curDiyUV.length &&
                      ((this._curDiyUV = b.getRelativeUV(
                        this.currTexture.uv,
                        this.currDisplayData.uvs,
                        this._curDiyUV,
                      )),
                      (this._curDiyUV = b.getAbsoluteUV(
                        this._diyTexture.uv,
                        this._curDiyUV,
                        this._curDiyUV,
                      ))),
                ...
                this.deformData &&
                  (a ||
                    (this._mVerticleArr = this.getSaveVerticle(
                      this._mVerticleArr,
                    ))),
                s.init2(n, p, this._mVerticleArr, _));
              var c,
                m = this.getDisplayMatrix();
              if (this._parentMatrix)
                if (m)
                  (e.Matrix.mul(m, this._parentMatrix, e.Matrix.TEMP),
                    a
                      ? (null == this._resultMatrix &&
                          (this._resultMatrix = new e.Matrix()),
                        (c = this._resultMatrix))
                      : (c = F._tempResultMatrix),
    ...
    skinMesh(t, e) {
      ...
      this._diyTexture
        ? ((a = this._diyTexture),
          ...
          (i = this._curDiyUV))
        : (i = this.currDisplayData.uvs);
      var s,
        n,
        h,
        l,
        o,
        u = this.currDisplayData.weights,
        p = this.currDisplayData.triangles,
        _ = 0,
        d = 0,
        c = 0,
        ...
        g = 0;
      if (
        ((F._tempVerticleArr.length = 0),
        (o = F._tempVerticleArr),
        this.deformData && this.deformData.length > 0)
      ) {
        var f = 0;
        for (y = 0, g = r.length; y < g; ) {
          for (c = r[y++] + y, _ = 0, d = 0; y < c; y++)
            ((n = t[r[y]]),
              (h = u[m] + this.deformData[f++]),
              (l = u[m + 1] + this.deformData[f++]),
              (x = u[m + 2]),
              (_ += (h * n.a + l * n.c + n.tx) * x),
              (d += (h * n.b + l * n.d + n.ty) * x),
              (m += 3));
          o.push(_, d);
        }
      } else
  ...
  ((F._tempMatrix = new e.Matrix()),
    (F._tempResultMatrix = new e.Matrix()),
    (F.useSameMatrixAndVerticle = !0),
    (F._tempVerticleArr = []));
  class w {
    constructor() {
      this.slotArr = [];
  ...
  class k {
    createTexture(t) {
      return (
        this.texture ||
          ((this.texture = new e.Texture(t.bitmap, this.uvs)),
  ...
  class L extends p {
    ...
    buildArmature(t = 0) {
      let e = new x(t);
      return ((e.templet = this), e);
    }
    _parse(t, i, a) {
      ((this._path = i.slice(0, i.lastIndexOf("/")) + "/"),
        t._addReference(),
        (this._mainTexture = t));
      var r = new e.Byte(a);
      ((this._aniVersion = r.readUTFString()),
        n.parse(this, r),
        this._aniVersion === P
          ? (this._isParseAudio = !0)
          : "LAYAANIMATION:1.6.0" != this._aniVersion &&
            console.log(
      ...
      for (let t = 0, e = this.getAnimationCount(); t < e; t++)
        this._graphicsCache.push([]);
      var s,
        h = new e.Byte(this.getPublicExtData()),
        l = 0,
        o = 0,
        u = 0,
        p = 0,
      ...
      for (let t = 0; t < b; t++)
        (this._path,
          ...
          (x = h.getFloat32()),
          (m = isNaN(x) ? p : x),
          (this.subTextureDic[T] = e.Texture.create(
            this._mainTexture,
            l,
            o,
            u,
      ...
      for (let t = 0; t < Y; t++)
        ((N = new g()),
          ...
          (R = h.readUTFString()),
          (V = h.readUTFString()),
          (N.length = h.getFloat32()),
          1 == h.getByte() && (N.inheritRotation = !1),
          1 == h.getByte() && (N.inheritScale = !1),
          (N.name = R),
          V && ((E = X[V]) ? E.addChild(N) : (this.mRootBone = N)),
          (X[R] = N),
          this.mBoneArr.push(N));
      this.tMatrixDataLen = h.getUint16();
      var W,
        z,
        G = h.getUint16(),
        q = Math.floor(G / this.tMatrixDataLen),
        H = this.srcBoneMatrixArr;
      for (let t = 0; t < q; t++)
        (((W = new y()).scX = h.getFloat32()),
          (W.skX = h.getFloat32()),
          (W.skY = h.getFloat32()),
          (W.scY = h.getFloat32()),
          (W.x = h.getFloat32()),
          ...
          8 === this.tMatrixDataLen &&
            ((W.skewX = h.getFloat32()), (W.skewY = h.getFloat32())),
          H.push(W),
          ((N = this.mBoneArr[t]).transform = W));
      var Q,
        Z,
        j = h.getUint16();
      for (let t = 0; t < j; t++) {
        ((z = new B()), (Q = h.getUint16()));
        for (let t = 0; t < Q; t++)
          (z.boneNames.push(h.readUTFString()),
            z.boneIndexs.push(h.getInt16()));
        ((z.name = h.readUTFString()),
          (z.targetBoneName = h.readUTFString()),
          (z.targetBoneIndex = h.getInt16()),
          (z.bendDirection = h.getFloat32()),
          (z.mix = h.getFloat32()),
          (z.isSpine = s),
          this.ikArr.push(z));
      }
      var J,
        ...
        tt = h.getUint16();
      for (let t = 0; t < tt; t++) {
        ((Z = new f()), (J = h.getUint16()));
        for (let t = 0; t < J; t++) Z.boneIndexs.push(h.getInt16());
        ((Z.name = h.getUTFString()),
          (Z.targetIndex = h.getInt16()),
          (Z.rotateMix = h.getFloat32()),
          (Z.translateMix = h.getFloat32()),
          (Z.scaleMix = h.getFloat32()),
          (Z.shearMix = h.getFloat32()),
          (Z.offsetRotation = h.getFloat32()),
          (Z.offsetX = h.getFloat32()),
          (Z.offsetY = h.getFloat32()),
          (Z.offsetScaleX = h.getFloat32()),
          (Z.offsetScaleY = h.getFloat32()),
          (Z.offsetShearY = h.getFloat32()),
          this.tfArr.push(Z));
      }
      var et,
        it,
        ...
        pt = h.getUint16();
      for (let t = 0; t < pt; t++) {
        ((($ = new M()).name = h.readUTFString()), (et = h.getUint16()));
        for (let t = 0; t < et; t++) $.bones.push(h.getInt16());
        (($.target = h.readUTFString()),
          ($.positionMode = h.readUTFString()),
          ($.spacingMode = h.readUTFString()),
          ($.rotateMode = h.readUTFString()),
          ($.offsetRotation = h.getFloat32()),
          ($.position = h.getFloat32()),
          ($.spacing = h.getFloat32()),
          ($.rotateMix = h.getFloat32()),
          ($.translateMix = h.getFloat32()),
          this.pathArr.push($));
      }
      var _t,
        dt = h.getInt16();
      for (let t = 0; t < dt; t++) {
        ...
        for (let t = 0; t < ct; t++) {
          (((ht = new D()).skinName = h.getUTFString()),
            (mt[ht.skinName] = ht),
            (it = h.getInt16()));
          for (let t = 0; t < it; t++) {
            ((lt = new v()),
              ht.deformSlotDataList.push(lt),
              (at = h.getInt16()));
            for (let t = 0; t < at; t++) {
              ((ot = new I()),
                lt.deformSlotDisplayList.push(ot),
                (ot.slotIndex = h.getInt16()),
                (ot.attachment = h.getUTFString()),
                (rt = h.getInt16()));
              for (let t = 0; t < rt; t++) {
                (1 == h.getByte()
                  ? ot.tweenKeyList.push(!0)
                  : ot.tweenKeyList.push(!1),
                  (st = h.getFloat32()),
                  ot.timeList.push(st),
                  (ut = []),
                  ot.vectices.push(ut),
                  (nt = h.getInt16()));
                for (let t = 0; t < nt; t++) ut.push(h.getFloat32());
              }
            }
          }
        }
      ...
      for (let t = 0; t < Mt; t++) {
        ((xt = h.getInt16()), (_t = []));
        for (let t = 0; t < xt; t++) {
          (((yt = new A()).time = h.getFloat32()), (gt = h.getInt16()));
          for (let t = 0; t < gt; t++) yt.drawOrder.push(h.getInt16());
          _t.push(yt);
        }
      ...
      for (let t = 0; t < It; t++) {
        ((Dt = h.getInt16()), (ft = []));
        for (let t = 0; t < Dt; t++)
          (((vt = new S()).name = h.getUTFString()),
            this._isParseAudio && (vt.audioValue = h.getUTFString()),
            (vt.intValue = h.getInt32()),
            (vt.floatValue = h.getFloat32()),
            (vt.stringValue = h.getUTFString()),
            (vt.time = h.getFloat32()),
            ft.push(vt));
        this.eventAniArr.push(ft);
      }
      var At = h.getInt16();
      if (At > 0) {
      ...
      var St,
        ...
        Tt = h.getInt16();
      for (let t = 0; t < Tt; t++)
        (((St = new F()).name = h.readUTFString()),
          (St.parent = h.readUTFString()),
          (St.attachmentName = h.readUTFString()),
          (St.srcDisplayIndex = St.displayIndex = h.getInt16()),
          (St.templet = this),
          (this.boneSlotDic[St.name] = St),
          null == (bt = this.bindBoneBoneSlotDic[St.parent]) &&
            (this.bindBoneBoneSlotDic[St.parent] = bt = []),
          bt.push(St),
          this.boneSlotArray.push(St));
      var Ct,
        Ft,
        wt,
        kt,
        ...
        Nt,
        Et,
        Rt = h.readUTFString().split("\n"),
        Vt = 0,
        Ot = h.getUint8();
      for (let t = 0; t < Ot; t++) {
        (((Ct = new w()).name = Rt[Vt++]), (kt = h.getUint8()));
        for (let t = 0; t < kt; t++) {
          (((Ft = new U()).name = Rt[Vt++]),
            (St = this.boneSlotDic[Ft.name]),
            (Ut = h.getUint8()));
          for (let t = 0; t < Ut; t++) {
            if (
              ((wt = new k()),
              this.skinSlotDisplayDataArr.push(wt),
              (wt.name = Rt[Vt++]),
              (wt.attachmentName = Rt[Vt++]),
              (wt.transform = new y()),
              (wt.transform.scX = h.getFloat32()),
              (wt.transform.skX = h.getFloat32()),
              (wt.transform.skY = h.getFloat32()),
              (wt.transform.scY = h.getFloat32()),
              (wt.transform.x = h.getFloat32()),
              (wt.transform.y = h.getFloat32()),
              Ft.displayArr.push(wt),
              (wt.width = h.getFloat32()),
              (wt.height = h.getFloat32()),
              (wt.type = h.getUint8()),
              (wt.verLen = h.getUint16()),
              (Y = h.getUint16()) > 0)
            ) {
              wt.bones = [];
              for (let t = 0; t < Y; t++) {
            ...
            if ((Bt = h.getUint16()) > 0) {
              wt.uvs = [];
              for (let t = 0; t < Bt; t++) wt.uvs.push(h.getFloat32());
            }
            if ((Pt = h.getUint16()) > 0) {
              wt.weights = [];
              for (let t = 0; t < Pt; t++) wt.weights.push(h.getFloat32());
            }
            if ((Lt = h.getUint16()) > 0) {
              wt.triangles = [];
              for (let t = 0; t < Lt; t++) wt.triangles.push(h.getUint16());
            }
            if ((Nt = h.getUint16()) > 0) {
              wt.vertices = [];
              for (let t = 0; t < Nt; t++) wt.vertices.push(h.getFloat32());
            }
            if ((Et = h.getUint16()) > 0) {
              wt.lengths = [];
              for (let t = 0; t < Et; t++) wt.lengths.push(h.getFloat32());
            }
          }
          Ct.slotArr.push(Ft);
        }
        ((this.skinDic[Ct.name] = Ct), this.skinDataArray.push(Ct));
      }
      (1 == h.getUint8()
        ? ((this.yReverseMatrix = new e.Matrix(1, 0, 0, -1, 0, 0)),
          K && K.setTempMatrix(this.yReverseMatrix))
        : K && K.setTempMatrix(new e.Matrix()),
        this.showSkinByIndex(this.boneSlotDic, 0));
    }
    getTexture(t) {
      let e = this.subTextureDic[t];
      return (
        e || (e = this.subTextureDic[t.substring(0, t.length - 1)]),
      ...
      if (h) {
        for (a = 0, r = h.slotArr.length; a < r; a++)
          (n = h.slotArr[a]) &&
            (s = t[n.name]) &&
            (s.showSlotData(n, i),
            i && "undefined" != s.attachmentName && "null" != s.attachmentName
              ? s.showDisplayByName(s.attachmentName)
              : s.showDisplayByIndex(s.displayIndex));
        return !0;
      }
      return !1;
    }
    getSkinIndexByName(t) {
      for (let e = 0, i = this.skinDataArray.length; e < i; e++) {
        if (this.skinDataArray[e].name == t) return e;
      }
      return -1;
    }
    getGrahicsDataWithCache(t, e) {
      return this._graphicsCache[t] && this._graphicsCache[t][e]
        ? this._graphicsCache[t][e]
        : null;
    }
    ...
    _disposeResource() {
      var t;
      for (let e in this.subTextureDic)
        null === (t = this.subTextureDic[e]) || void 0 === t || t.destroy();
      this._mainTexture._removeReference();
      for (var e = 0, i = this.skinSlotDisplayDataArr.length; e < i; e++)
        this.skinSlotDisplayDataArr[e].destory();
      ...
      load(t) {
        return Promise.all([
          t.loader.fetch(
            t.url,
            "arraybuffer",
            t.progress.createCallback(),
            t.options,
          ),
          t.loader.load(
            e.Utils.replaceFileExtension(t.url, "png"),
            null,
            t.progress.createCallback(),
          ),
        ]).then((e) => {
          ...
          let i = new L();
          return (i._parse(e[1], t.url, e[0]), i);
        });
      }
    },
  ),
    (0, e.ClassUtils.regClass)("Skeleton", x));
  class N extends e.Sprite {
      ...
      (super(),
        ...
        t
          ...
          : ((this._movieClipList = [this]),
            (this._isRoot = !0),
            this._setBitUp(e.NodeFlags.DISPLAY)));
    }
    destroy(t = !0) {
    ...
    set index(t) {
      ((this._playIndex = t),
        ...
        this._labels &&
          this._labels[t] &&
          this.event(e.Event.LABEL, this._labels[t]));
    }
    addLabel(t, e) {
      ...
      if (this._data && this._playing) {
        ...
        if (
          ...
          this._labels &&
            ...
            this.event(e.Event.LABEL, this._labels[this._playIndex]),
    ...
    _clear() {
      if (
        (this.stop(), (this._idOfSprite.length = 0), !this._parentMovieClip)
      ) {
        var t, i;
        for (
          this.timer.clear(this, this.updates),
      ...
      var a;
      for (a in this._loadedImage) {
        let t = this._loadedImage[a];
        t && (e.ILaya.Loader.clearRes(a, t), (this._loadedImage[a] = !1));
      }
      (this.removeChildren(),
        (this.graphics = null),
      ...
      for (
        ...
        switch (u.getUint16()) {
          case 12:
            if (
              ...
              if (!(a = o[r])) {
                a = o[r] = new e.Sprite();
                var _ = new e.Sprite();
                (_.loadImage(this.basePath + p + ".png"),
                  (this._loadedImage[this.basePath + p + ".png"] = !0),
                  a.addChild(_),
                  _.size(u.getFloat32(), u.getFloat32()));
                var d = u._getMatrix();
                _.transform = d;
              }
              a.alpha = 1;
          ...
          case 4:
            ...
            break;
          case 5:
            o[u.getUint16()][N._ValueList[u.getUint16()]] = u.getFloat32();
            break;
          case 6:
    ...
    load(t, i = !1, a = null) {
      (this.stop(),
        ...
        (this._movieClipList = [this]),
        (this._source = t),
        i && (a = a || t.split(".swf")[0] + ".json"),
        e.ILaya.loader.load(a ? [t, a] : [t], e.Loader.BUFFER).then((a) => {
          var r;
          if (!a) return void this.event(e.Event.ERROR, "file not find");
          let s = i
            ? null === (r = a[1]) || void 0 === r
              ? void 0
              : r.dir
            : t.split(".swf")[0] + "/image/";
          this._initData(new e.Byte(a[0].data), s);
        }));
    }
    _initState() {
    ...
    _initData(t, i) {
      this.basePath = i;
      let a = t.getUint16();
      for (let e = 0; e < a; e++) this._ids[t.getInt16()] = t.getInt32();
      ((this.interval = 1e3 / t.getUint16()),
        this._setData(t, this._ids[32767]),
        this._initState(),
        this.play(0),
        this.event(e.Event.READY),
  ...
  ((N._ValueList = [
    ...
    (t.AnimationPlayer = o),
    (t.AnimationState = l),
    (t.AnimationTemplet = p),
    (t.BezierLerp = u),
    (t.Bone = g),
    (t.BoneSlot = F),
    (t.DeformAniData = D),
    (t.DeformSlotData = v),
    (t.DeformSlotDisplayData = I),
    (t.DrawOrderData = A),
    (t.EventData = S),
    (t.GraphicsAni = _),
    (t.IAniLib = i),
    (t.IkConstraint = d),
    (t.IkConstraintData = B),
    (t.KeyFramesContent = s),
    (t.MeshData = T),
    (t.MovieClip = N),
    (t.PathConstraint = c),
    (t.PathConstraintData = M),
    (t.Skeleton = x),
    (t.SkinData = w),
    (t.SkinMeshForGraphic = C),
    (t.SkinSlotDisplayData = k),
    (t.SlotData = U),
    (t.Templet = L),
    (t.TfConstraint = m),
    (t.TfConstraintData = f),
    (t.Transform = y),
    (t.UVTools = b));
