  ...
  <main class="debug-page">
    <section class="hero">
      <div>
        ...
        <h1>UI PNG + Atlas Viewer</h1>
        <p class="subtitle">
          Browse every frame in <code>ui.atlas.txt</code> and preview the
          cropped sprite from <code>ui.png</code>.
        </p>
      </div>
    ...
    <template v-else>
      <section class="panel atlas-panel">
        ...
        <div class="atlas-shell">
          <img :src="texturePath" alt="ui texture atlas" class="atlas-image" />
        </div>
      </section>
      ...
      <section class="toolbar">
        <label class="search-box">
          ...
          <input
            v-model="searchTerm"
            type="text"
            placeholder="Try button, bar, icon..."
          />
        </label>
      </section>
...
const atlasPath = "/resources/ui.atlas.txt";
const texturePath = "/resources/ui.png";
...
.debug-page {
  ...
  padding: 32px;
  background:
    radial-gradient(circle at top left, rgba(255, 145, 107, 0.18), transparent 28%),
    radial-gradient(circle at top right, rgba(90, 190, 255, 0.18), transparent 24%),
